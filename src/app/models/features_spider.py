...
class EquivalencesLivensaLiving:
    FEATURES = {
        "Piscina": LodgerinFeatures.FEATURE_SWIMMING_POOL.value,
        "Piscina climatizada": LodgerinFeatures.FEATURE_SWIMMING_POOL.value,
        "Áreas de estudio": LodgerinFeatures.FEATURE_STUDY_AREA.value,
        "Control de acceso": LodgerinFeatures.FEATURE_LOCKABLE_ROOMS.value,
        "Gimnasio": LodgerinFeatures.FEATURE_GYM.value,
        "Sala de juegos": LodgerinFeatures.FEATURE_GAMES_COURT.value,
        "Lavandería": None,
        "*custo extra": None,
        "Parking de bicis": LodgerinFeatures.FEATURE_BICYCLE_PARKING.value,
        "Aire Acondicionado": LodgerinFeatures.FEATURE_AIR_CONDITIONING.value,
        "Urban Art": None,
        "Biblioteca": LodgerinFeatures.FEATURE_STUDY_AREA.value,
        "Recepción 24/7": LodgerinFeatures.FEATURE_CONCIERGE_RECEPTION.value,
        "Terraza": LodgerinFeatures.FEATURE_BALCONY.value,
        "Cine": LodgerinFeatures.FEATURE_RECREATIONAL_ROOM.value,
        "Video Vigilancia": LodgerinFeatures.FEATURE_CAMERAS.value,
        "Individual": LodgerinFeatures.FEATURE_PRIVATE_BATH.value,
        "Baño": LodgerinFeatures.FEATURE_PRIVATE_BATH.value,
        " TV": LodgerinFeatures.FEATURE_TV.value,
        "TV": LodgerinFeatures.FEATURE_TV.value,
        "Smart TV": LodgerinFeatures.FEATURE_TV.value,
        "Cocina": None,
        "Kitchenette": None,
        "Wifi": LodgerinFeatures.FEATURE_STREAMING_SERVICES.value,
        "AA": LodgerinFeatures.FEATURE_AIR_CONDITIONING.value,
        "Luz | Agua | Internet ¡Incluidos!": None,
        "Doble": LodgerinFeatures.FEATURE_PRIVATE_BATH.value,
        "Desk": LodgerinFeatures.FEATURE_STUDY_AREA.value,
        "Zona de estudio": LodgerinFeatures.FEATURE_STUDY_AREA.value,
        "Salas de estudio": LodgerinFeatures.FEATURE_STUDY_AREA.value,
        "Sala de estar": LodgerinFeatures.FEATURE_LIVING_ROOM.value,
        "*coste extra": None,
        "Salas de música": None,
        "Servicio de comidas": None,
        "Parking": LodgerinFeatures.FEATURE_CAR_PARKING.value,
        "Zona de juegos": LodgerinFeatures.FEATURE_GAMES_COURT.value,
        "Servicio de limpieza": LodgerinFeatures.FEATURE_ROOM_CLEANING.value,
        "Cocina Común": None,
        "Sala de trabajos": LodgerinFeatures.FEATURE_COWORKING_SPACE.value,
        "Vídeo vigilancia": LodgerinFeatures.FEATURE_CAMERAS.value,
        "Pared de escalada": LodgerinFeatures.FEATURE_GAMES_COURT.value,
        "Zona multimedia": LodgerinFeatures.FEATURE_RECREATIONAL_ROOM.value,
        "Sala de estudio": LodgerinFeatures.FEATURE_STUDY_AREA.value,
        "Catering": None,
    }
